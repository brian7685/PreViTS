...
local vgg_sound = import "../dataset/vgg_sound.libsonnet";
local vgg_sound_test = import "../dataset/vgg_sound_test.libsonnet";
local loss_lambda = import "../optimizer/loss_lambda.libsonnet";
local vgg_sound_debug = import "../dataset/vgg_sound_debug_b.libsonnet";
{
    arch: 'resnet18',
    ...
    dataset: vgg_sound_debug, // or kinetics100
