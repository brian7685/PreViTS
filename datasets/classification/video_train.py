...
class VideoDataset_constrained(Dataset):
    ...
    def __getitem__(self, index: int) -> Tuple[List[torch.Tensor], int]:
        ...
        if 1:#vid=='01SaXyGY5SM_000030':#'D2ISzNuhtxE_000009':
            ...
            mask_l = {}
            for name in glob('/export/home/b_data/vgg_sound-256/seg/train_split/'+class_name+'/'+vid+'/*'):
                #print(name)
        ...
        if 1:#vid=='01SaXyGY5SM_000030':
            ...
            while match==0:
                ...
                mask_loc_q = mask_l[mid_frame_q] #mid frame num folder full path

                mask_img = mask_loc_q.split('/')[-1] #mid frame num folder
        ...
        if 1:#vid=='01SaXyGY5SM_000030':
            ...
            for k in range(2):
                ...
                #if vid=='8m3k09ZFRbA_000118':
                if crop_T_max.shape[1]==0 or crop_T_max.shape[2]==0:
                    print('crop_T_max',class_name,vid,gt_mask.shape,clip_list_temp[k].shape,crop_T_max.shape,left,top,right,bot)
